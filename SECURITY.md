...
- **REGL** (WebGL wrapper) - bundled locally in `/lib/`
- **gl-matrix** (matrix math) - bundled locally in `/lib/`
- **@playwright/test** (development testing only) - not included in production builds
